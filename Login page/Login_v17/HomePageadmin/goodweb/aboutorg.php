            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="http://13.233.56.180/project/Login%20page/Login_v17/HomePageadmin/goodweb/aboutorg.php">About Organisations</a></li>
                        <li><a href="http://13.233.56.180/project/Login%20page/Login_v17/HomePageadmin/goodweb/gallery.php">Gallery</a></li>
                        <li><a href="http://13.233.56.180/project/Login%20page/Login_v17/HomePageadmin/goodweb/aboutus.php">About us</a></li>
                    </ul>
                </div>
            </div>
        </nav>
				...
				<div class="col-md-12">
					<div class="banner">
						...
						<ul class="page-title-link">
							<li><a href="#">Home</a></li>
							<li><a href="#">About Organisations</a></li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <div id="test-box" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <li><a href="http://13.233.56.180/project/Login%20page/Login_v17/HomePageadmin/goodweb/Organisation_Registration_Form/colorlib-regform-3/Organisation_Registration_Form.php">+Add new organisation</a></li>
            </div><!-- end title -->
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                ...
                                <h4>James Fernando <small>- Founder of ARSO</small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
