...
<body>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="http://13.233.56.180/project/Login%20page/Login_v17/HomePage/goodweb/aboutorg.php">About Organisations</a></li>
                        <li><a class="active" href="http://13.233.56.180/project/Login%20page/Login_v17/HomePage/goodweb/gallery.php">Gallery</a></li>
    ...
    <div id="portfolio" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>A very heartfelt thanks to all those who became the voice of these helpless animals.<br></h3>
                <p class="lead">
                    Below are few of the ARSO operations that took place in the past one year that has given a second chance in life to these animals.
                </p>
            </div><!-- end title -->
        </div><!-- end container -->
                ...
                <div class="col-md-12">
                    <nav class="portfolio-filter text-center">
                        <ul>
                            ...
                            <li><a class="btn btn-dark btn-radius btn-brd" data-toggle="tooltip" data-placement="top" title="5" href="#" data-filter=".cat1">Dogs</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" href="#" data-toggle="tooltip" data-placement="top" title="12" data-filter=".cat2">Cats</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" href="#" data-toggle="tooltip" data-placement="top" title="21" data-filter=".cat3">Birds</a></li>
                            <li><a class="btn btn-dark btn-radius btn-brd" href="#" data-toggle="tooltip" data-placement="top" title="11" data-filter=".cat4">Cattle</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div id="da-thumbs" class="da-thumbs portfolio">
                <div class="post-media pitem item-w1 item-h1 cat1">
                    <a href="uploads/portfolio_01.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued by Tanish <small> The 4 street dogs poisoned</small></h3>
                ...
                <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="uploads/portfolio_02.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Adopted by Varthaman <small>Cat with severe case of asthma</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat1">
                    <a href="uploads/portfolio_03.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Treated by Dr Ramachandra Hegde <small>Dog severely injured in a road accident.</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat4">
                    <a href="uploads/portfolio_04.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Shelter provided by Mudipu Goshala<small>To injured calves rescued from illegal cattle trafficking</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat3">
                    <a href="uploads/portfolio_05.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued Pigeon<small>From a circus show.</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="uploads/portfolio_06.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued & Taken into Atavar Animal Shelter<small> Cat that was thrown into river</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat1">
                    <a href="uploads/portfolio_07.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued by a Volunteer<small>Dog injured due to a fire-cracker mishappening.</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat4">
                    <a href="uploads/portfolio_08.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued by a Volunteer <small>Calf that fell from a hill side.</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                <div class="post-media pitem item-w1 item-h1 cat3">
                    <a href="uploads/portfolio_09.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Rescued by a Volunteer<small>Bird that was injured during cutting of a tree</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
                ...
                <div class="post-media pitem item-w1 item-h1 cat2">
                    <a href="uploads/portfolio_10.jpg" data-rel="prettyPhoto[gal]">
                        ...
                        <div>
                            <h3>Treated by Dr.Shanaya Gupta <small>Cat,a victim of accident due to Cerebellar hypoplasia</small></h3>
                            <i class="flaticon-unlink"></i>
                        </div>
                    </a>
                </div>
	...
	<div id="services" class="parallax section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>How to contact us to register youself? </h3>
                <p class="lead">Contact us at ARSO2019@gmail.com</p>
                <p class="lead">You can also reach to us at +99880046372</p>
            </div><!-- end title -->
</div>
</div>
</ul>
