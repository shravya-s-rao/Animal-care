...
// {
	...
	$qry=mysqli_query($con,"INSERT INTO `feedback`(`name`, `email`, `username`, `service`, `improve`,`message`) VALUES('$n','$e','$u','$se','$im','$mes')") or die(mysqli_error($con));
	...
	if($qry==true)
	{
		echo "
          <script>
              ...
              window.location.href='http://localhost/dbms/login%20page/Login_v17/HomePage/goodweb/index.php';
              </script>
		";
	}
	else
